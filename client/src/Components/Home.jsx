...
function Home(props) {
    return (
            <div className="w-fit md:grid md:grid-cols-2 lg:grid-cols-2 items-center mt-8 sm:flex sm:flex-col bg-gray-100">
                <div className="flex flex-col text-center">
                    ...
                    <Link to="/services">
                       <p className="text-m font-bold text-[#405cf5] my-0 underline hover:text-indigo-600">Services</p>
                    </Link>
                </div>
